...
class CocoConfig(Config):
    ...
    NUM_CLASSES = 1 + 3  # Background + Driver, Wheel, and Hands
...
class CocoDataset(utils.Dataset):
    def load_coco(self, dataset_dir, subset, class_ids=None,
        ...
        """
        subset = "train" if subset != "val" else "val"
        ...
        # Add classes
        for i in class_ids:
            self.add_class("DriverSafety", i, coco.loadCats(i)[0]["name"])

        # Add images
        for i in image_ids:
            self.add_image(
                "DriverSafety", image_id=i,
    ...
    def load_mask(self, image_id):
        ...
        if image_info["source"] != "DriverSafety":
        ...
        for annotation in annotations:
            class_id = self.map_source_class_id(
                "DriverSafety.{}".format(annotation['category_id']))
            if class_id:
...
def build_coco_results(dataset, image_ids, rois, class_ids, scores, masks):
    ...
    for image_id in image_ids:
        ...
        for i in range(rois.shape[0]):
            ...
            result = {
                "image_id": image_id,
                "category_id": dataset.get_source_class_id(class_id, "DriverSafety"),
